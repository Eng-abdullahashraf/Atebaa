          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.0),
                containerApp("وَإِذَا مَرِضْتُ فَهُوَ يَشْفِينِ  (80 الشعراء)",
                    TextAlign.center),
                SizedBox(height: 8),
                titleApp("نصيحه نبويه:"),
                SizedBox(height: 8),
                containerApp(
                    ...
                    "سبع فتسع، فإنها لا تكادُ تُجاوز تسعاً بإذنِ اللهِ».",
                    TextAlign.center),
                SizedBox(
                  height: 8,
                ),
                titleApp("نصيحه اليوم:"),
                SizedBox(
                  height: 8,
                ),
                containerApp(
                    ...
                    "5 -الاستحمام على الأقل مرة فى اليوم.",
                    TextAlign.start),
                SizedBox(
                  height: 8,
                ),
                titleApp("المقالة اليوميه"),
                SizedBox(
                  height: 8,
                ),
                containerApp(
